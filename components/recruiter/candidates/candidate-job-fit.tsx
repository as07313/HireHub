...
interface CandidateJobFitProps {
  candidate: any
}
...
export function CandidateJobFit({ candidate }: CandidateJobFitProps) {
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-2xl font-bold">{candidate.jobFitScore}</span>
